...
function Footer() {
  return (
    <footer className="py-12 px-6 border-t border-[#E5E1EF]">
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-8 lg:items-center lg:justify-between">
        <div className="flex items-center gap-3">
        ...
        <div className="flex flex-col sm:flex-row gap-4 sm:gap-8 text-sm text-center sm:text-left">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-3 w-full lg:w-auto">
          <FooterSocials className="justify-center sm:justify-start" />
          <p className="text-sm text-[#635F69] text-center sm:text-left">
