            ...
            <div className="w-full max-w-md">
                ...
                <div className="text-center mb-8">
                    <Link href="/" className="inline-flex items-center gap-3 mb-6">
                        <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#A78BFA] to-[#7C3AED] shadow-clay-orb flex items-center justify-center">
                            <span className="text-white font-black text-2xl" style={{ fontFamily: 'Nunito, sans-serif' }}>K</span>
                        </div>
                    </Link>
                    <h1
                ...
                <div className="clay-card shadow-clay-card p-8">
                    ...
                    <button
                        ...
                        disabled={isLoading}
                        className="w-full h-14 px-6 rounded-[20px] bg-white border-2 border-[#E5E1EF] text-[#332F3A] font-bold text-lg shadow-clay-card hover:shadow-clay-card-hover hover:-translate-y-1 active:scale-[0.98] transition-all duration-200 disabled:opacity-50 disabled:hover:translate-y-0 flex items-center justify-center gap-3"
                        style={{ fontFamily: 'Nunito, sans-serif' }}
                    >
                        {isLoading ? (
                ...
                <div className="text-center mt-6">
                    <Link
                        href="/"
                        className="text-[#635F69] hover:text-[#7C3AED] font-medium transition-colors inline-flex items-center gap-2"
                    >
