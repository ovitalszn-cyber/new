...
export const DOC_NAV: { title: string; items: NavItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/docs/endpoints/player-props', label: 'Player props', id: 'player-props' },
      { href: '/docs/endpoints/media', label: 'Media', id: 'media' },
      { href: '/docs/endpoints/gaps', label: 'Gaps', id: 'gaps' },
