  ...
  return (
    <div className="min-h-screen bg-[#F4F1FA]">
      ...
      <footer className="py-6 px-6 border-t border-[#E5E1EF]">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-[#635F69]">
          <div className="flex items-center gap-2">
            <span>© 2024 KashRock. All rights reserved.</span>
            <div className="hidden md:block w-px h-4 bg-[#E5E1EF]" />
            <span className="text-xs text-[#8F899A]">v1.0.0</span>
          </div>
          <FooterSocials size="sm" />
        </div>
      </footer>
    </div>
  );
