...
export default function LoginPage() {
  const handleGoogleLogin = () => {
    signIn('google', { callbackUrl: '/console' });
  };
        ...
        <div className="bg-[#0C0D0F] border border-white/5 rounded-lg p-8">
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="px-2 bg-[#0C0D0F] text-zinc-500">or</span>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full bg-black/50 border border-white/10 rounded-sm px-3 py-2.5 text-sm text-white placeholder-zinc-600 focus:outline-none focus:border-zinc-500 transition-colors"
                disabled
              />
            </div>
            <button
              disabled
              className="w-full bg-white/5 text-zinc-500 px-4 py-2.5 rounded-sm text-sm font-medium cursor-not-allowed"
            >
